...
<style>
    ...
    .order-sidebar {
        ...
        max-height: 80vh; /* Max height with scrolling */
        overflow-y: auto;
        position: sticky;
        top: 100px; /* Stick below the header */
    }
    .quantity-control {
        display: flex;
        align-items: center;
    ...
    .finalize-order-btn {
        ...
        padding: 1rem; /* Make button taller */
        font-size: 1.1rem;
        font-weight: 600;
        border-radius: 12px;
        border: none;
    ...
    .finalize-order-btn:hover {
        ...
        box-shadow: 0 8px 25px rgba(229, 169, 169, 0.6);
    }
    .order-sidebar h3 {
        font-size: 1.8rem;
    ...
    .order-sidebar li {
        padding: 15px 5px !important; /* Taller list items */
    }
    .order-sidebar li span {
        font-size: 1.05rem;
        font-weight: 500;
    }
...
<main class="main-wrapper" style="padding-top: 20px;">
  ...
  <div class="menu-page-layout">
    ...
    <aside class="order-sidebar">
        <h3 style="text-align: center; margin-bottom: 20px; color: var(--text-dark);">Current Order</h3>
        <?php
        ...
        <?php else: ?>
            <ul style="list-style: none; padding: 0; margin: 0;">
                <?php foreach ($current_order_items as $order_item): ?>
                    <li style="display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid var(--border-color);">
                        <span style="color: var(--text-dark); flex-grow: 1;"><?php echo htmlspecialchars($order_item['name']); ?></span>
                        <div class="quantity-control">
                            ...
                            <span style="font-weight: 600; min-width: 20px; text-align: center;"><?php echo $order_item['quantity']; ?></span>
